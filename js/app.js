...
function renderIntro() {
  ...
  div.innerHTML = `
    <div class="intro-hero">
      ...
      <p class="intro-lead">מדריך מעשי לנשים שרוצות לעבוד עם AI בצורה יעילה</p>
    </div>
    ...
    <div class="intro-cta-wrap">
      <button class="intro-cta-btn" onclick="navigate(1)">מתחילות</button>
...
function renderCh1() {
  ...
  div.innerHTML = `
    ...
    <p class="screen-subtitle">רוב הנשים כותבות בקשה קצרה ומצפות לתוצאה מדויקת. אבל קצר לא תמיד אומר ברור.</p>
...
/* --- Screen 3: Chapter 3 ---------------------------------- */
const formulaItems = [
  { label: 'משימה', title: 'מה את רוצה שהכלי יעשה?', desc: 'פועל + נושא. כמה שיותר ספציפי.', example: 'במקום: "תכתוב לי פוסט"\nעדיף: "כתוב פוסט אינסטגרם של 4 שורות על שינה לנשים עסוקות"' },
  ...
  { label: 'מטרה',  title: 'מה את רוצה שיקרה?', desc: 'מה המטרה? מה את רוצה שהקורא יחשוב, ירגיש, יעשה?', example: 'מטרה: "שיבינו שאפשר להתחיל מקטן ושירשמו לסדנה"' },
...
function renderEnding() {
  ...
  div.innerHTML = `
    <div class="ending-wrap">
      ...
      <h2 class="screen-title">מעכשיו עובדות ברור יותר</h2>
    </div>
